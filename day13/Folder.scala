...
class Folder(val points: List[(Int, Int)]){
  ...
  def createArray(): Array[Array[Int]] = {
    ...
    var filling: Array[Array[Int]] = Array.ofDim[Int](verticalSize,horizontalSize)
    for(point <- points){
      val (x,y) = point
      filling(y)(x) = 1
    }
...
object Folds {
  def verticalInverse(bottom: Array[Array[Int]]): Array[Array[Int]] = {
    var filling: Array[Array[Int]] = Array.ofDim[Int](bottom.size, bottom(0).size)
  ...
  def addArrays(top: Array[Array[Int]], bottomFlipped: Array[Array[Int]]): Array[Array[Int]] = {
    var filling: Array[Array[Int]] = Array.ofDim[Int](bottomFlipped.size, bottomFlipped(0).size)
